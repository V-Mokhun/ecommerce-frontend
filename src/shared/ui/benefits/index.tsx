...
const BENFEITS_ITEMS = [
  {
    ...
    icon: (
      <Icon name="benefits-1" className="w-7 md:w-10 shrink-0 h-6 md:h-8" />
    ),
  },
  {
    text: "Guarantee",
    icon: (
      <Icon name="benefits-2" className="w-7 md:w-10 shrink-0 h-6 md:h-11" />
    ),
  },
  {
    text: "Free Shipping over 1000$",
    icon: (
      <Icon name="benefits-3" className="w-9 md:w-14 shrink-0 h-8 md:h-12" />
    ),
  },
  {
    text: "24/7 Support",
    icon: (
      <Icon name="benefits-4" className="w-7 md:w-10 shrink-0 h-6 md:h-11" />
    ),
  },
];

export const Benefits = ({ noContainer }: BenefitsProps) => {
  const content = (
